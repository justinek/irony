...
var allStates = ["terrible", "bad", "ok", "good", "amazing"];
...
var experiment = {
  ...
  utterances: new Array(numTrials),
  ironyRatings: new Array(numTrials),
  ...
  description: function() {
    ...
    var gen = getRadioCheckedValue(3, "genderButton");
  ...
  next: function() {
    if (numComplete > 0) {
      experiment.ironyRatings[currentTrialNum] = parseFloat(document.getElementById("ironySliderValue1").value);
      experiment.stateRatings[currentTrialNum] = getRadioCheckedValue(1, "weather");
      ...
      clearForm(document.forms[0], 2);
      clearForm(document.forms[1]);
      clearForm(document.forms[2], 1);
    }
    if (numComplete >= numTrials) {
      ...
      showSlide("stage");
      name = allNames.shift();
      utterance = allStates.random();
      $("#utterance").html(utterance);
      experiment.utterances[currentTrialNum] = utterance;
...
$("#ironySlider1").slider({
               ...
               //$("#slider1 .ui-slider-handle").hide();
               create: function( event, ui) {
                    $("ironySlider1.ui-slider-handle").css({
                      "opacity": 0
                   });
               },
               slide: function( event, ui ) {
                $('#ironySlider .ui-slider-handle').show();
                   $("#ironySlider1 .ui-slider-handle").css({
                      "background":"#E0F5FF",
                      "border-color": "#001F29",
               ...
               change: function( event, ui ) {
                   $('#ironySliderValue1').attr('value', ui.value);
                   $("#ironySlider1").css({"background":"#99D6EB"});
                   //$("#slider1 .ui-slider-handle").show();
                   $("#ironySlider1 .ui-slider-handle").css({
                     "background":"#667D94",
                     "border-color": "#001F29",
